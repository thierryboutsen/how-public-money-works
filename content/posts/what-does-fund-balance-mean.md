...
The [local tax flow guide](/where-do-your-local-taxes-actually-go) explains why restrictions and fund pathways matter before a resource reaches a service.

## Questions to ask before calling it a surplus

1. Which fund and reporting period does the number describe?
2. Which classifications make up the balance?
3. How much is cash versus another asset?
4. What obligations or commitments follow the reporting date?
5. Is any planned use included in the next budget?
6. Does policy identify a target or minimum, and why?
7. Do the notes explain a major change?
...
Read the number with the fund, notes, timing, and policy. That method produces a better civic question than calling every balance a surplus or every decline a crisis. More practical reading guides are in the [Insights library](/insights).
...
- No reserve target or local financial-health conclusion is provided.
- publishAllowed remains false.

Factual validation checklist:
- claim: Fund balance is not identical to cash.
  sourceUsed: NCES Fund Balance and Net Assets
  status: conceptually-validated
- claim: Governmental fund balance has five constraint-oriented classifications.
  sourceUsed: NCES Balance Sheets and Fund Balance Classifications
  status: conceptually-validated
- claim: Restrictions and commitments arise from different sources.
  sourceUsed: NCES Fund Balance and Net Assets
  status: conceptually-validated
- claim: Unassigned is the general fund residual after other classifications.
  sourceUsed: NCES Balance Sheets and Fund Balance Classifications
  status: conceptually-validated
- claim: Availability requires context beyond a headline balance.
  sourceUsed: NCES Fund Balance and Net Assets
  status: conceptually-validated
- claim: A specific balance requires local statements and notes.
  sourceUsed: NCES Fund Balance and Net Assets
