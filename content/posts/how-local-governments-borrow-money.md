...
The [city budget guide](/what-is-a-city-budget-and-why-should-you-care) is a useful starting point for locating debt service and capital appropriations.

## Read the documents in layers

For a specific borrowing, look for:

1. the capital plan or staff report explaining the need;
2. the resolution, ordinance, or voter material authorizing the financing;
3. the official statement or offering document;
4. the debt-service schedule and pledged revenue description;
5. annual financial-report notes and later continuing disclosures.
...
Follow the authorization, security, and repayment documents. The [Insights library](/insights) provides more guides for connecting those records to budgets and capital plans.
...
- claim: Municipal bonds are debt securities issued by governmental entities.
  sourceUsed: Investor.gov Municipal Bonds
  status: conceptually-validated
- claim: Debt proceeds create repayment obligations over time.
  sourceUsed: Investor.gov Municipal Bonds
  status: conceptually-validated
- claim: General obligation and revenue bonds rely on different pledged support.
  sourceUsed: Investor.gov Municipal Bonds Glossary
  status: conceptually-validated
- claim: Official statements explain issuer, security, and risk.
  sourceUsed: Investor.gov Municipal Bonds and Credit Risk
  status: conceptually-validated
- claim: Authorization requirements vary by debt and jurisdiction.
  sourceUsed: Census Government Finance Glossary
  status: jurisdictional-variation-validated-no-national-rule-asserted
- claim: A specific borrowing requires official local documents.
  sourceUsed: Investor.gov Municipal Bonds and Credit Risk
