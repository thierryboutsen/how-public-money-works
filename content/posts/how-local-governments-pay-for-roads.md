...
This mix is why it is risky to say that one local tax “paid for the road.” The [guide to local tax flows](/where-do-your-local-taxes-actually-go) explains how several sources can move through general, restricted, and intergovernmental pathways.
...
The [Insights library](/insights) includes more practical guides to budgets, funds, and public decisions.
...
- No project, amount, eligibility determination, or jurisdiction is asserted.
- publishAllowed remains false.

Factual validation checklist:
- claim: Roads can involve different levels and types of government.
  sourceUsed: FHWA Federal-Aid Highway Program; Census Classification Manual
  status: conceptually-validated
- claim: Maintenance and capital work can appear in different planning and budget documents.
  sourceUsed: FHWA Highway Finance Data Guide
  status: conceptually-validated-local-source-required-if-example-added
- claim: Road projects may combine local, state, federal, borrowed, and other resources.
  sourceUsed: FHWA Local Government Highway Finance; Census Classification Manual
  status: conceptually-validated
- claim: Federal aid depends on program eligibility and does not establish road ownership.
  sourceUsed: FHWA Federal-Aid Highway Program
  status: conceptually-validated
- claim: Interfund transfers do not add new resources to the government as a whole.
  sourceUsed: Census Classification Manual
  status: conceptually-validated
- claim: A planned project is not necessarily fully funded or authorized.
  sourceUsed: FHWA Federal-Aid Highway Program
  status: conceptually-validated-local-source-required-if-example-added
-->
