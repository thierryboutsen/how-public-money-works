...
Esse documento encerra a cadeia de cálculo; não explica por completo como a receita seguirá por fundos e serviços. Para a etapa seguinte, leia [Para Onde Vão os Seus Impostos Locais?](/pt-br/para-onde-vao-os-seus-impostos-locais).

## Assessment, levy, rate e bill não são sinônimos

Uma forma curta de lembrar as distinções:

- **Assessment:** valor ou medida tributável atribuída no sistema aplicável.
- **Levy:** decisão ou autorização de receita de imposto vinculada a uma autoridade.
- **Rate ou alocação:** mecanismo que conecta a necessidade autorizada à base tributável.
- **Bill:** cobrança emitida depois dos cálculos e ajustes aplicáveis.
...
Com esses papéis claros, um documento denso se transforma em perguntas respondíveis. A biblioteca de [Publicações](/insights) reúne guias sobre fundos e documentos que entram em cena depois da arrecadação.
...
- Nenhum rate, valor, prazo, isenção ou orientação de contestação foi incluído.
- publishAllowed remains false.

Factual validation checklist:
- claim: O Census classifica property taxes como tributos ligados à propriedade e medidos por valor.
  sourceUsed: U.S. Census Bureau Government Finances Glossary
  status: conceptually-validated
- claim: Funções de assessment, levy, cálculo, cobrança e arrecadação podem ser divididas entre órgãos.
...
- claim: Levy e valor avaliado são conceitos distintos.
  sourceUsed: Washington State Department of Revenue Levies; Census Government Finances Glossary
  status: conceptually-validated
- claim: Mudança de valor avaliado não determina sozinha a mudança da cobrança.
  sourceUsed: Washington State Department of Revenue Property Tax Levy Limit
  status: conceptually-validated-local-source-required-if-example-added
- claim: Autoridades tributantes locais podem ter papéis jurídicos e fiscais separados.
  sourceUsed: Census Government Organization Glossary
  status: jurisdictional-variation-validated-no-national-rule-asserted
- claim: Isenções, limites, avaliação, contestação e cobrança variam por jurisdição.
