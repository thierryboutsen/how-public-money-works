...
Para revisar primeiro o documento de planejamento, veja [O Que É um Orçamento Municipal — e Por Que Você Deveria se Importar?](/what-is-a-city-budget-and-why-should-you-care). O artigo está em inglês, mas os conceitos ajudam a distinguir plano e resultado.
...
1. Qual governo e qual período o relatório cobre?
2. Quais demonstrações são amplas e quais são por fundo?
3. Onde está a comparação entre orçamento e realizado, e qual base ela usa?
4. Quais mudanças a administração identifica como relevantes?
5. Quais notas explicam dívida, restrições, compromissos ou itens incomuns ligados à sua pergunta?
...
A biblioteca de [Publicações](/insights) reúne outros guias para seguir essas perguntas entre documentos de finanças públicas.
...
- Esta versão conceitual não contém valores ou conclusões jurisdicionais.
- publishAllowed remains false.

Factual validation checklist:
- claim: O orçamento aprovado olha para a frente e o relatório anual apresenta um período encerrado.
  sourceUsed: Texas Comptroller ACFR Guide; Washington State Auditor GAAP Reporting Requirements
  status: conceptually-validated
- claim: Demonstrações amplas e de fundos governamentais adotam perspectivas diferentes.
  sourceUsed: Washington State Auditor GAAP Reporting Requirements; NCES Financial Statements
  status: conceptually-validated
- claim: Valores de orçamento e relatório podem diferir por base, momento, classificação ou escopo.
...
- claim: Notas e análise da administração acrescentam contexto aos totais.
  sourceUsed: Washington State Auditor GAAP Reporting Requirements
  status: conceptually-validated
- claim: O orçamento final alterado pode diferir do orçamento originalmente aprovado.
  sourceUsed: Washington State Auditor GAAP Reporting Requirements; Texas Comptroller ACFR Guide
  status: conceptually-validated-local-source-required-if-example-added
- claim: Estrutura do relatório e arranjos de fundos variam entre governos.
