---
title: "What Is a Local Government Audit?"
subtitle: "A plain-English guide to audit scope, opinions, findings, and the questions a report can—and cannot—answer."
slug: "what-is-a-local-government-audit"
language: "en"
translationKey: "local-government-audit-reader-guide"
translations:
...
tags:
  ...
  - financial reporting
  - public records
primaryKeyword: "local government audit"
secondaryKeywords:
...
excerpt: "A local government audit has a defined objective and scope. Learn how to read the opinion, findings, recommendations, and limits without assuming too much."
...
p2Blockers: []
securityWarnings: []
seoTitle: "What Is a Local Government Audit?"
metaDescription: "Learn what local government audits examine, how to read opinions and findings, and why an audit cannot guarantee that every problem was found."
---

# What Is a Local Government Audit?
...
- a **financial audit**, which may provide an independent opinion on whether specified financial statements are presented fairly under the applicable reporting framework;
- a **performance audit**, which may examine effectiveness, efficiency, operations, or whether a program is meeting defined objectives;
- an **accountability or compliance-focused audit**, which may examine whether public resources are protected and whether selected laws, regulations, grant terms, or policies were followed; and
- a **federal award audit**, which may examine compliance connected to certain federal funds.
...
- every error, control weakness, or instance of noncompliance was detected;
- fraud does not exist;
- every public program is efficient or effective;
- every financial decision was wise;
- management implemented every recommendation; or
- conditions remained unchanged after the period examined.
...
If you are still learning how budgets connect to financial documents, start with [the basic guide to a city budget](/what-is-a-city-budget-and-why-should-you-care) and then return to the audit report with the period and scope in mind. More public-finance explainers are available in the [Insights library](/insights).

## Questions to ask while reading

You do not need to be an auditor to ask disciplined questions:

- What exact question or objective did this audit address?
- Which government, fund, program, statements, and period were included?
- Which areas were outside the scope?
- What standards and criteria did the auditors use?
- Is the report offering an opinion, a conclusion, findings, or some combination?
- What evidence or risk makes each finding important?
- What did management say it would do?
- Where will follow-up appear?
...
- [U.S. Government Accountability Office — Government Auditing Standards](https://www.gao.gov/yellowbook)
- [U.S. Government Accountability Office — Role as an Audit Institution](https://www.gao.gov/about/what-gao-does/audit-role)
- [Washington State Auditor — Report Types](https://sao.wa.gov/reports-data/report-types)
- [Washington State Auditor — Anatomy of an Audit](https://sao.wa.gov/about-audits/anatomy-audit/anatomy-audit-text-version)
...
- claim: Government audits can include financial, performance, compliance/accountability, and federal-award work with different objectives.
  sourceUsed: GAO Government Auditing Standards; Washington State Auditor Report Types
  status: conceptually-validated
- claim: Audit scope and objectives bound the conclusion a reader can draw.
  sourceUsed: GAO Government Auditing Standards
  status: conceptually-validated
- claim: Audits and investigations are distinct oversight activities.
  sourceUsed: GAO Office of Inspector General overview; GAO Government Auditing Standards
  status: conceptually-validated
- claim: Financial audit opinions address specified statements under an applicable framework.
  sourceUsed: GAO Government Auditing Standards; Washington State Auditor Report Types
  status: conceptually-validated
- claim: Findings are tied to objectives, criteria, evidence, and significance.
  sourceUsed: GAO Government Auditing Standards; Washington State Auditor Anatomy of an Audit
  status: conceptually-validated
- claim: Reasonable assurance is not absolute assurance and does not guarantee discovery of every fraud or error.
  sourceUsed: GAO Government Auditing Standards
  status: conceptually-validated
- claim: Report structure, terminology, audit authority, and follow-up practice vary.
  sourceUsed: Washington State Auditor Anatomy of an Audit; jurisdiction-specific source required only if an example is added
  status: conceptually-validated-local-source-required-if-example-added
- claim: Official audit documents may be published by state or local oversight and finance bodies.
  sourceUsed: Washington State Auditor audit-report resources
  status: conceptually-validated-local-source-required-if-example-added
-->
