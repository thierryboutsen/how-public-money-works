...
sourceLevel: "conceptual-official-sources-needed"
precisionRisk: "high"
draftAllowed: true
...
Fees are charges connected to a service, permit, license, facility, or other public function. A fee may help support the cost of the related activity, but the relationship is not identical everywhere. The authority to charge a fee, the amount, and the permitted use can vary.

### Fines

Fines are financial penalties connected to a violation or enforcement process. They are not simply another name for taxes or fees.

### Grants

Grants are funds provided by another government, agency, foundation, or institution for a defined purpose or under defined conditions. A grant may support a project, program, service, or period of work.

### Transfers

Transfers are movements of money from one government, fund, or public account to another. A transfer may connect different parts of the public-finance system, but it does not necessarily represent new money entering government as a whole.
...
That approach leaves room for local variation while making public choices easier to examine. It can help residents distinguish a tax from a fee, a grant from a transfer, and a general fund from a restricted one.
...
- Requires source validation before moving to content/posts/.
