...
const RAW_ENTRIES = [
  {
    category: 'Budgeting', sourceRefs: ['gfoaBudget', 'gfoaBudgeting'],
  ...
  },
  {
    ...
    pt: { term: 'Assessed Value (valor tributável)', definition: 'Assessed value é o valor atribuído ao imóvel para aplicar uma cobrança ou taxa de property tax. Pode ser diferente do valor de mercado porque a lei estadual pode usar percentuais, classificações, isenções ou outros ajustes.', why: 'É um dos elementos usados para entender uma conta de property tax.', note: 'Os sistemas e percentuais de avaliação dependem da lei estadual e local; valor tributável não deve ser tratado como sinônimo de valor de mercado.', related: ['Property Tax', 'Tax Base', 'Tax Rate'], content: articleTaxes }
  },
  {
  ...
  },
  {
    ...
    en: { term: 'Annual Comprehensive Financial Report (ACFR)', definition: 'An Annual Comprehensive Financial Report, or ACFR, is a comprehensive annual government financial report prepared under applicable public-sector reporting requirements. GASB changed the preferred name from Comprehensive Annual Financial Report to Annual Comprehensive Financial Report.', why: 'The acronym ACFR helps readers find the government’s broader annual financial reporting package.', note: 'Not every government publishes an ACFR in the same format or under the same legal requirement.', related: ['Annual Financial Report', 'Financial Statement', 'Transparency'], content: ['/annual-financial-report-local-government'] },
    pt: { term: 'Annual Comprehensive Financial Report (ACFR)', definition: 'Annual Comprehensive Financial Report, ou ACFR, é um relatório financeiro anual abrangente do governo, preparado conforme os requisitos de prestação de contas aplicáveis. O GASB mudou o nome preferencial de Comprehensive Annual Financial Report para Annual Comprehensive Financial Report.', why: 'A sigla ACFR ajuda o leitor a localizar o conjunto mais amplo de informações financeiras anuais.', note: 'Nem todo governo publica um ACFR no mesmo formato ou sob a mesma exigência legal.', related: ['Annual Financial Report', 'Financial Statement', 'Transparency'], content: ['/pt-br/relatorio-financeiro-anual-governo-local'] }
  },
  {
    category: 'Budgeting', sourceRefs: ['gfoaBudgeting', 'gfoaBudget'],
    en: { term: 'Balanced Budget', definition: 'A balanced budget is a budget in which planned resources are sufficient to cover planned uses under the government’s applicable budget rules. A structurally balanced budget generally means recurring revenues support recurring expenditures, rather than relying on one-time fixes.', why: 'A budget can appear balanced while still depending on temporary resources.', note: 'The legal definition and accounting basis of balance differ across jurisdictions.', related: ['Operating Budget', 'Revenue', 'Fund Balance'], content: articleBudget },
    pt: { term: 'Balanced Budget (orçamento equilibrado)', definition: 'Balanced budget é um orçamento em que os recursos planejados são suficientes para cobrir os usos planejados segundo as regras aplicáveis. Um orçamento estruturalmente equilibrado normalmente significa que receitas recorrentes sustentam despesas recorrentes, sem depender de soluções pontuais.', why: 'Um orçamento pode parecer equilibrado e ainda depender de recursos temporários.', note: 'A definição legal e a base contábil do equilíbrio variam entre jurisdições.', related: ['Operating Budget', 'Revenue', 'Fund Balance'], content: articleBudget }
  },
  {
    category: 'Debt & Capital', sourceRefs: ['gfoaDebt'],
  ...
  {
    category: 'Budgeting', sourceRefs: ['gfoaBudgeting'],
  ...
  {
    category: 'Budgeting', sourceRefs: ['gfoaBudget'],
  ...
  {
    category: 'Funds & Accounting', sourceRefs: ['gfoaFundBalance'],
  ...
  {
    category: 'Funds & Accounting', sourceRefs: ['censusFinance', 'gasb34'],
  ...
  },
  {
    ...
    en: { term: 'Fund Balance', definition: 'Fund balance is the net position reported for governmental funds under applicable reporting or budgetary rules. It can include resources with different constraints and is not simply the same as cash in a bank account.', why: 'The classification and availability of fund balance matter more than the headline number alone.', note: 'GAAP fund balance and budgetary fund balance may differ because recognition and timing rules differ.', related: ['General Fund', 'Restricted Revenue', 'Unrestricted Revenue', 'Encumbrance'], content: ['/where-do-your-local-taxes-actually-go', '/what-does-fund-balance-mean'] },
    pt: { term: 'Fund Balance (saldo de fundo)', definition: 'Fund balance é a posição líquida reportada para governmental funds conforme regras de reporte ou orçamento aplicáveis. Pode incluir recursos com restrições diferentes e não é simplesmente o dinheiro em uma conta bancária.', why: 'A classificação e a disponibilidade importam mais do que o número principal isolado.', note: 'Fund balance em GAAP e fund balance orçamentário podem divergir por causa de regras diferentes de reconhecimento e timing.', related: ['General Fund', 'Restricted Revenue', 'Unrestricted Revenue', 'Encumbrance'], content: ['/pt-br/para-onde-vao-os-seus-impostos-locais', '/pt-br/o-que-significa-fund-balance'] }
  },
  {
    ...
    pt: { term: 'General Fund (fundo geral)', definition: 'General fund é o principal governmental fund usado para contabilizar e reportar muitas atividades e recursos gerais que não precisam ser reportados em outro fundo. Não é necessariamente o lugar de cada dólar sem restrição.', why: 'O general fund costuma ser central no orçamento operacional, mas seu saldo não é automaticamente disponível para qualquer gasto.', note: 'Papel legal e conteúdo dependem do governo e das normas aplicáveis.', related: ['Fund', 'Fund Balance', 'Governmental Fund'], content: ['/pt-br/fundo-geral-vs-fundos-de-receita-especial'] }
  },
  {
    category: 'Debt & Capital', sourceRefs: ['gfoaDebt'],
    en: { term: 'General Obligation Bond', definition: 'A general obligation bond is debt backed by the issuer’s general credit and taxing power, subject to the pledge and legal terms of the issue. It is not necessarily repaid from one named project or revenue stream.', why: 'The security pledge helps readers understand which resources may support repayment.', note: 'Pledge language, voter approval, tax limits, and legal treatment vary by jurisdiction.', related: ['Bond', 'Debt Service', 'Property Tax'], content: ['/how-local-governments-borrow-money'] },
    pt: { term: 'General Obligation Bond (título garantido pela capacidade geral)', definition: 'General obligation bond é uma dívida apoiada pelo crédito geral e pelo poder tributário do emissor, conforme a garantia e os termos legais da emissão. Não é necessariamente paga por um único projeto ou fluxo de receita identificado.', why: 'A garantia ajuda a entender quais recursos podem sustentar o pagamento.', note: 'Texto da garantia, aprovação popular, limites tributários e tratamento legal variam por jurisdição.', related: ['Bond', 'Debt Service', 'Property Tax'], content: ['/pt-br/como-governos-locais-tomam-dinheiro-emprestado'] }
  },
  {
    category: 'Funds & Accounting', sourceRefs: ['gasb34'],
  ...
  },
  {
    ...
    pt: { term: 'Internal Control (controle interno)', definition: 'Internal control é o conjunto de processos contínuos usados pela administração para oferecer reasonable assurance sobre operações eficazes, relatórios confiáveis, conformidade e proteção de recursos. Não é garantia de que todo erro ou fraude será evitado.', why: 'Controles mostram como uma organização reduz riscos em decisões e transações cotidianas.', note: 'Estruturas e exigências variam; o Green Book da GAO é federal, embora possa informar organizações não federais.', related: ['Audit', 'Transparency', 'Encumbrance'], content: ['/pt-br/o-que-e-uma-auditoria-de-governo-local'] }
  },
  {
    ...
    pt: { term: 'Levy (lançamento ou cobrança tributária)', definition: 'Levy pode significar o ato legal de instituir um tributo ou o valor total autorizado pelo governo, conforme o contexto. Em property tax, costuma ser analisado junto da base tributável e da taxa aplicada.', why: 'Levy ajuda a distinguir a autoridade ou meta do governo da conta final de um imóvel.', note: 'O termo pode significar ato, valor autorizado ou taxa conforme o estado e o documento.', related: ['Assessed Value', 'Property Tax', 'Tax Base', 'Tax Rate'], content: articleTaxes }
  },
  {
    category: 'Revenues & Taxes', sourceRefs: ['tennesseeTax', 'floridaTax'],
    en: { term: 'Millage Rate', definition: 'A millage rate is a property-tax rate expressed in mills, commonly meaning a tax amount per one thousand dollars of taxable value. The exact calculation and terminology are set by state and local rules.', why: 'Millage is a common U.S. term that appears on property-tax documents but has no single Brazilian equivalent.', note: 'Assessment ratios, exemptions, and the value of one mill vary in presentation across jurisdictions.', related: ['Assessed Value', 'Levy', 'Property Tax', 'Tax Rate'], content: articleTaxes },
    pt: { term: 'Millage Rate (taxa em mills)', definition: 'Millage rate é uma taxa de property tax expressa em mills, geralmente como valor do tributo por mil dólares de valor tributável. O cálculo e a terminologia exatos dependem das regras estaduais e locais.', why: 'Millage é um termo comum nos EUA que aparece em documentos de property tax e não tem equivalente único no Brasil.', note: 'Percentuais de avaliação, isenções e a apresentação de um mill variam entre jurisdições.', related: ['Assessed Value', 'Levy', 'Property Tax', 'Tax Rate'], content: articleTaxes }
  },
  {
    category: 'Budgeting', sourceRefs: ['gfoaBudget'],
  ...
  {
    category: 'Debt & Capital', sourceRefs: ['gfoaDebt'],
    en: { term: 'Revenue Bond', definition: 'A revenue bond is debt expected to be repaid primarily from a specified revenue stream, such as charges from a utility or facility, under the bond’s legal pledge. The pledged revenue and coverage rules are central to the credit structure.', why: 'The repayment source affects risk, rates, and which users or activities may bear the cost.', note: 'A government’s legal pledge may include reserves, additional bonds tests, or other support; read the documents.', related: ['Bond', 'Debt Service', 'Enterprise Fund', 'User Fee'], content: ['/how-local-governments-borrow-money'] },
    pt: { term: 'Revenue Bond (título garantido por receita)', definition: 'Revenue bond é uma dívida que deve ser paga principalmente por um fluxo de receita especificado, como cobranças de uma utility ou instalação, conforme a garantia legal da emissão. A receita empenhada e as regras de cobertura são centrais à estrutura.', why: 'A fonte de pagamento afeta risco, taxas e quais usuários ou atividades podem suportar o custo.', note: 'A garantia pode incluir reservas, testes para novas emissões ou outros apoios; é preciso ler os documentos.', related: ['Bond', 'Debt Service', 'Enterprise Fund', 'User Fee'], content: ['/pt-br/como-governos-locais-tomam-dinheiro-emprestado'] }
  },
  {
    category: 'Revenues & Taxes', sourceRefs: ['censusFinance', 'gasb54'],
    en: { term: 'Restricted Revenue', definition: 'Restricted revenue is revenue whose use is limited by an external party, law, contract, grant, voter action, or another enforceable requirement. The restriction concerns use; it does not automatically identify a particular fund type.', why: 'A restricted receipt may not be available for a new priority even when it increases total revenue.', note: 'The source and legal terms determine whether a restriction is external, formal, temporary, or permanent.', related: ['Grant', 'Fund', 'Special Revenue Fund', 'Unrestricted Revenue'], content: ['/where-do-your-local-taxes-actually-go'] },
    pt: { term: 'Restricted Revenue (receita restrita)', definition: 'Restricted revenue é uma receita cujo uso é limitado por terceiro externo, lei, contrato, grant, decisão popular ou outra exigência aplicável. A restrição diz respeito ao uso; não identifica automaticamente um tipo de fundo.', why: 'Uma receita restrita pode não estar disponível para uma nova prioridade mesmo aumentando a receita total.', note: 'Fonte e termos legais determinam se a restrição é externa, formal, temporária ou permanente.', related: ['Grant', 'Fund', 'Special Revenue Fund', 'Unrestricted Revenue'], content: ['/pt-br/para-onde-vao-os-seus-impostos-locais'] }
  },
  {
    category: 'Funds & Accounting', sourceRefs: ['gasb54'],
    en: { term: 'Special Revenue Fund', definition: 'A special revenue fund is a governmental fund used in circumstances where specific restricted or committed revenue sources support specified purposes, subject to applicable standards. A restricted resource and a special revenue fund are not synonyms.', why: 'The distinction prevents readers from inferring a fund type from a restriction alone.', note: 'The criteria and classification must be checked against the government’s financial report and applicable standards.', related: ['Fund', 'Governmental Fund', 'Restricted Revenue', 'General Fund'], content: ['/general-fund-vs-special-revenue-funds'] },
    pt: { term: 'Special Revenue Fund (fundo de receita especial)', definition: 'Special revenue fund é um governmental fund usado quando fontes específicas de receita restrita ou committed sustentam finalidades determinadas, conforme normas aplicáveis. Recurso restrito e special revenue fund não são sinônimos.', why: 'A distinção impede inferir o tipo de fundo apenas pela existência de uma restrição.', note: 'Critérios e classificação devem ser verificados no relatório financeiro e nas normas aplicáveis.', related: ['Fund', 'Governmental Fund', 'Restricted Revenue', 'General Fund'], content: ['/pt-br/fundo-geral-vs-fundos-de-receita-especial'] }
  },
  {
    category: 'Revenues & Taxes', sourceRefs: ['tennesseeTax', 'floridaTax'],
...
function renderGlossaryBody(locale = 'en') {
  ...
  const filters = categories.map((category) => `<button type="button" data-glossary-filter="${escapeHtml(category)}">${escapeHtml(category)}</button>`).join('');
  ...
  return `<div class="glossary-tools">
  ...
  <div class="glossary-filters"><button type="button" class="on" data-glossary-filter="all">${escapeHtml(labels.all)}</button>${filters}</div>
